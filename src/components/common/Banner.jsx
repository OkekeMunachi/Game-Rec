  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        ...
        <h1 className='banner-title text-uppercase'>Discover Your Next Favorite Game</h1>
        <p className='lead-text'>Explore a personalized selection of games tailored to your interests. Find new favorites and keep up with gaming trends, all in one convenient place. Ideal for gamers looking for fresh experiences and customized recommendations.</p>
