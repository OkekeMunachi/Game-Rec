        ...
        <div className='footer-content text-white d-grid container'>
          <div className='footer-item'>
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>
              for <span>gamers</span>
            </a>
            <p className='para-text'>Discover games tailored to your interests, explore new favorites, and stay updated on trends—all in one place. Perfect for gamers seeking fresh, personalized experiences.</p>
          </div>
